declare namespace ffmpeg {
  export type WatermarkSettings = Partial<{
  ...
  export type FrameToJPGSettings = Partial<{
  ...
  export type StandardVideoMetadata = Partial<{
    title: string;
    author: string;
    album_artist: string;
    album: string;
  ...
  export type WMVMetadata = Partial<{
    title: string;
    author: string;
    copyright: string;
    comment: string;
  ...
  export type AVIMetadata = Partial<{
    IARL: string;
    IART: string;
    ICMS: string;
    ICMT: string;
  ...
  export type FLVMetadata = Partial<{
    duration: Duration;
    filesize: string;
    encoder: string;
    width: number;
